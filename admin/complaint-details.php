...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8088/cms/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>&user_id=<?php echo htmlentities($row['userId']);?>');" title="Update order">
	
											 <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8088/cms/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
