...
<tbody>
<?php 
$query=mysql_query("select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status is null order by tblcomplaints.userId desc");
